...
import { FaCogs, FaUserPlus, FaSignInAlt, FaSignOutAlt, FaTachometerAlt } from 'react-icons/fa';
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          {status === 'loading' ? (
            ...
            <>
              {/* ======================================================= */}
              {/* == INI ADALAH INTEGRASI DASHBOARD == */}
              {/* ======================================================= */}
              ...
              <span className="hidden sm:block">Halo, {session.user?.name}!</span>
              <button 
